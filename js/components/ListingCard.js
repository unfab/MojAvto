...
export function createListingCard(listing) {
    ...
    // === SPREMEMBA: Stanje dobimo iz centralnega vira ===
    const { favorites, compareItems } = stateManager.getState();
    ...
    // Preverimo stanje za Primerjavo
    ...
    // Pripravimo HTML za značko z oceno cene
    let priceBadgeHTML = '';
    if (listing.priceEvaluation) {
        priceBadgeHTML = `<span class="price-badge ${listing.priceEvaluation.score}">${listing.priceEvaluation.text}</span>`;
    }
